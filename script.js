...
function ActualGame() {
    ...
    node = document.createTextNode("Dear player,\nWelcome to the French revolution game! We are delighted to have you here. This is a quick game help to help you play. At this time, You wil gain "+income+" sous every month. A loaf of bread costs 13 sous. Your income and bread price will fluctuate baed on certain events. You need at least 15 bread in a month, or you will lose "+difficutyNeg+" heath per bread missing. If your heath drops below 0, you die in the next month. You can keep yourself happy by spending money on yourself, such as purchasing jeweery. You lose "+difficutyNeg+" happiness a month. If happiness drops to 0, you will kill yoursef in the next month. Safety will go down or up by choices made in monthly events. Droping below 0 will result in being executed or murdered. If any of your stats drop below "+difficultyMax+", you have a chance to die. The lower it is, the higher the chance.")
